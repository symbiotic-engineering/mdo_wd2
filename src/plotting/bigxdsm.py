...
# Expanded system-dynamics pieces (placed on the main diagonal)
...
#x.add_process(
#    ["solve", "rigidbody", "hydraulics","solve"],
#    arrow=True,
#)
#x.add_process(
#    ["solve", "hydraulics", "rigidbody","solve"],
#    arrow=True,
#)
...
x.connect("opt", "hydraulics", r"A_p,V_{acc}")
...
x.connect("solve", "rigidbody", r"\text{Time Steps}")
x.connect("solve", "hydraulics", r"\text{Time Steps}")
x.connect("rigidbody", "solve", r"\text{residuals}=0")
x.connect("hydraulics", "solve", r"\text{residuals}=0")
x.connect("hydraulics", "opt", r"\text{Piston Pressure} \geq \text{min}")
x.connect("rigidbody", "opt", r"\text{Piston Motion} \leq \text{max}")
